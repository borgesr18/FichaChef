...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      ...
      outline: 'border-2 border-[#5AC8FA]/30 hover:border-[#5AC8FA] text-[#1B2E4B] hover:text-[#5AC8FA] bg-white hover:bg-[#5AC8FA]/5 focus:ring-[#5AC8FA]/50 hover:scale-[1.02] active:scale-[0.98]',
      ghost: 'text-[#1B2E4B] hover:text-[#5AC8FA] hover:bg-[#5AC8FA]/10 focus:ring-[#5AC8FA]/50 hover:scale-[1.02] active:scale-[0.98]',
